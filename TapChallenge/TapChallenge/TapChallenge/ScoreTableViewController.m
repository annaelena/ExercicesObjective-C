...
-(void)viewWillAppear:(BOOL)animated{
    ...
    //forzo il refresh dei dati all'interno del TableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    NSString *text = [ NSString stringWithFormat:@"Row %li - Section %@", indexPath.row, self.scoresArray[indexPath.row]];
